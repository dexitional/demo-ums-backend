        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (isUser) {
                    ...
                    // Roles & Privileges
                    const roles = yield sso.userRole.findMany({ where: { userId: id }, include: { appRole: { select: { title: true, app: { select: { tag: true, title: true } } } } } });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (isUser) {
                    ...
                    const photo = data ? (_d = data === null || data === void 0 ? void 0 : data.applicant) === null || _d === void 0 ? void 0 : _d.photo : `${process.env.UMS_DOMAIN}/photos/?tag=${encodeURIComponent(username)}`;
                    // Construct UserData
                    const userdata = {
                        user,
                        roles: [],
